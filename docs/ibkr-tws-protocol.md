...
| ← server  | 7   | `PORTFOLIO_VALUE`     | Per-symbol marks / open P&L (PER-73) |
| ← server  | 8   | `ACCT_UPDATE_TIME`    | The venue's stamp on the account snapshot (PER-74) |
| ← server  | 58  | `MARKET_DATA_TYPE`    | Tier the venue granted (PER-180) |
