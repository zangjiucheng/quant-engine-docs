...
> and the gradient-boosted `gbdt` method added by PER-220.
>
...
- **Methods**: ridge (default), lasso (EPIC-50b) and `gbdt`
  (PER-220) ship today. Neural-net inference via ONNX was planned
...
- **64 features is a hard ceiling, not a guideline**: the per-bar
  ...
  (`BoundAst::kMaxPredictFeatures`). Before PER-160 the ceiling was
